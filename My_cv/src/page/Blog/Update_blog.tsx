...
type Edit_blog = {
  onUpdateBlog:(blog:IpBlog)=>void;
}
const Update_blog = (props:Edit_blog) => {
const {register,handleSubmit,formState:{errors},reset}=useForm<IpBlog>();
const navigate = useNavigate();
const {id} = useParams();
const [blog,setblogs] = useState<IpBlog[]>([]);
useEffect(()=>{
